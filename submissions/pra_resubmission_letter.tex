...
\end{refcomment}
\response There is a compromise between the efficacy of mu-metal shielding and high numerical aperture optical access required in a wide range of vacuum-based experiments.
Moreover, mu-metal shielding is incompatible with sensing magnetic phenomena inherent to the environment beyond the vacuum chamber.
The scheme presented here provides band-selective sensitivity to such fields.
...
\end{refcomment}
\response 
We agree that the relatively new term ``continuous dynamical decoupling'' is in the broad category of the well-established area of ``dressed state physics''.
Nevertheless referring to our work as continuous dynamical decoupling is wholly consistent with the broader literature cited.
