...
\authordetails{
    ...
    Monash University \\
    Victoria 3800 \\ Australia\\ % Your city, zip code, country, etc
...
%   HEADER CONTENTS
%---------------------------------------------------------
\logo{monash_logo.pdf} % Logo filename
...
Because our quantum gas is a coherent spin ensemble, weak measurement allows dynamical decoupling to be observed in real-time with a single experimental preparation.
 % ; weak measurements of superconducting qubits and nitrogen-vacancy (NV) centers require thousands of repeated preparation and detection cycles to measure what we do in
...
% This demonstration weds clock-state metrology with continuous measurement, advancing a platform for measuring oscillating magnetic fields in noisy environments.
...
% \footnotetext{\hspace*{\fill}{\footnotesize \centering %\em 
