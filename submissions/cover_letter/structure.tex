...
\address{
	...
	\hspace{0.072\textwidth}{\color{gray}\vhrulefill{1pt}} \\[-0.01\textheight] % Horizontal rule, adjust hspace if your logo is wide and \vhrulefill for the thickness of the rule
