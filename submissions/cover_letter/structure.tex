...
%---------------------------------------------------------
\address{
    \includegraphics[width=9cm]{\logo} % Include the logo of author institution
    \hspace{0.0\textwidth} % Position of the institution logo, increase to move left, decrease to move right
    ...
    \makebox[0ex][r]{\textbf{School of Physics and Astronomy}} \hspace{-0.018\textwidth} % Print author name and title with a little whitespace to the right
    ~\\[-0.005\textheight] % Reduce the whitespace above the horizontal rule
    \hspace{0.072\textwidth}{\color{lightgray}\vhrulefill{1pt}} \\[-0.01\textheight] % Horizontal rule, adjust hspace if your logo is wide and \vhrulefill for the thickness of the rule
    \authordetailsblock % Include the letter author's details on the right side of the page under the horizontal rule
    \hspace{-0.28\textwidth} % Horizontal position of the author details block, increase to move left, decrease to move right
    \vspace{-0.05\textheight} % Move the date and letter content up for a more compact look
}
...
\renewcommand{\opening}[1]{
    {\raggedright\fromaddress\vspace{0.05\textheight} \\ % Print the header and from address here, add whitespace to move date down
    % \hspace*{\longindentation}\today\hspace*{\fill}\par} % Print today's date, remove \today to not display it
    \hspace*{\longindentation}June 26, 2017\hspace*{\fill}\par} % Print today's date, remove \today to not display it
...
\signature{R. P. Anderson, for the authors} % The signature is a combination of the author's name and title
...
\renewcommand{\closing}[1]{
    ...
    \parbox{\indentedwidth}{
        ...
        \includegraphics[width=4cm]{rpa_signature.png} \\
