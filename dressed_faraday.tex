...
\begin{figure}
    ...
    Magnetic field fluctuations $\delta B_z(t)$ of amplitude $\unit[1]{mG}$ induced by mains power are manifest as asymmetric frequency modulation of the $\omega_{13}$ and $\omega_{23}$ sidebands, while the $\omega_{12}$ transition remains relatively unaffected.
    The corresponding spectral peaks have linewidths $\unit[xx]{Hz}$, $\unit[126]{Hz}$, and $\unit[36]{Hz}$, respectively.
    The $\omega_{12}$ linewidth is transform-limited, whereas the broadened peaks of the less decoupled $\omega_{23}$ transition exhibit a skew (third-moment) of $\unit[115]{Hz}$ (upper sideband) and $-\unit[137]{Hz}$.
    }
\end{figure}
...
Restricting attention to the upper sidebands, the two closest to the carrier are  ladder-type transitions
