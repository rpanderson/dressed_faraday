...
In this regime, a synthetic clock transition arises which is only quartically-sensitive to noise, surviving much larger amplitude fluctations than conventional quadratic decoupling.
...
Weak measurment allows this Fourier transform spectroscopy to be performed many times in one shot; previously Fourier transform spectroscopy has been used to measure band structures of a spin-orbit coupled BEC using projective measurements over many shots~\cite{valdes-curiel_fourier_2017}.
...
In finalising this work we became aware of measurements of the same rf-dressed system by Dimitris \etal~\cite{dimitris_synthetic_2017} using Rabi spectroscopy and projective readout. 
