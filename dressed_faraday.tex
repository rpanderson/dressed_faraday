...
\end{figure}
    ...
    \item (How) The $\hat{F}_z^2$ interaction has been controlled using static magnetic fields, microwave ac Stark shifts and tensor-light shifts of off-resonant magnetic and electric dipole transitions, respectively. 
    \item (What) This nonlinear term has been used to traverse the magnetic phase space of a spinor quantum gas, drive quantum quenches of same, initiate \note{blah, Bloch}, enact spin-squeezing (shear of coherent spin states),     
