...
\note{Structure of background theory: Introduce Hamiltonian for CoDD (clock states have been introduced so splitting will come naturally), show eigen energies of for varying q and seperations. Point out in figure that curvature of $\omega_{12}$ starts positive but becomes negative. By intermediate value theorem, it must become vanishing. Use second order perturbation theory to derive qmagic. }
