...
We measured the dressed spectrum for a range of $q_R \in [0.2, 0.5]$ by varying the resonant magnetic field $B_0$ [applied rf frequency $f_{\text{rf}}$] from $3.549\unit{G}$ [$2.493\unit{MHz}$] to $5.568\unit{G}$ [$3.911\unit{MHz}$], with a fixed Rabi frequency of $\Omega/(2\pi) = 4.505(3)\unit{kHz}$ ($B_{\text{rf}} = 6.414(4)\unit{mG}$).
