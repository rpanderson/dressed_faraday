...
For example, with no deliberate modulation of the Rabi frequency or detuning, we observe the spectrogram amplitude shown in \ref{fig:static_coupling}.
Amplitude modulation of the Faraday signal about the carrier frequency at $f_{\text{rf}} = \omega_{\text{rf}}/(2\pi)$ results in three upper and lower sidebands, each corresponding to a dressed state transition $\ket{i} \leftrightarrow \ket{j}$.
\begin{figure}
