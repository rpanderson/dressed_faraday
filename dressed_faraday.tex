...
The spectrum in \reffig{fig:acquisition_pipeline} would take order 3 hours to acquire with single-shot Stern-Gerlach imaging, compared to a single $\unit[20]{s}$ shot required here; all data for \reffig{fig:curvature_vs_qR} were acquired in $5$ minutes.
