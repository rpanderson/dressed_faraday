...
\begin{itemize}
    ...
    \item Moreover, $\hat{H}_{\text{rwa}}$ meets the requirements of reconstructing pure $SU(2F+1)$ states from a weak measurement of $\expect{\hat{F}_x}$~\note{deutsch_random_unitary_maps}; thus one can use the measurement record for quantum state estimation, but the spectrogram is similarly rich in Hamiltonian and density matrix information. 
